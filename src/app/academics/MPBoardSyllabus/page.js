  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 className="text-4xl border-2  mt-20 mb-4 font-bold bg-gradient-to-r from-cyan-200 to-cyan-600 bg-clip-text text-transparent text-center text-white pt-5">
