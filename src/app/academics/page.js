  ...
  return (
    <>
        ...
        >
          <div className="w-full p-4 relative">
            ...
            <div className="flex space-x-4 mt-20">
              <button
                className="bg-white hover:bg-gray-300 text-cyan-400 font-bold py-2 px-4 rounded "
                onClick={() => {
      ...
      <div className="min-h-100 p-10 flex justify-center items-center flex-col mt-12">
        <h1
          className=" text-white text-2xl font-solid flex justify-center   bg-cyan-400 rounded-xl p-2
           "
        >
          Our Feature
        </h1>
          ...
          {[
            {
              ...
              link1: "/labsImages/2 (1).jpg",
              link2: "/labsImages/2 (2).jpg",
              link3: "/labsImages/2 (3).jpg",
              link4: "/labsImages/2 (16).jpg",
            },
            {
              heading: "Science Lab",
              paragraph:
              ...
              link1: "/labsImages/2 (12).jpg",
              link2: "/labsImages/2 (18).jpg",
              link3: "/labsImages/2 (4).jpg",
              link4: "/labsImages/2 (11).jpg",
            },
            {
              ...
              link1: "/images/3 (1).jpeg",
              link2: "/images/3 (2).jpeg",
              link3: "/images/3 (3).jpeg",
              link4: "/images/3 (4).jpeg",
