...
const Modal = ({ showModal, toggleModal }) => {
  ...
  <button type="submit" className="text-white justify-center flex items-center bg-yellow-500 hover:bg-cyan-400 focus:ring-4 focus:outline-none focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800">
