...
export default function AcademicStudentCard({ cardDetails }) {
  ...
  return (
    <>
      <div className="relative flex w-full max-w-[26rem] flex-col rounded-xl border-cyan-400 border-2 bg-clip-border bg-white text-gray-700 ">
        <div className="relative lg:mx-4 mt-4 mx-2 overflow-hidden rounded-xl bg-cyan-gray-500 bg-clip-border text-white shadow-lg shadow-cyan-gray-500/40">
