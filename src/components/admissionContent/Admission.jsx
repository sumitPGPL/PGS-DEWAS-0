            ...
            <div className="flex flex-col md:flex-row md:justify-around items-center bg-cover">
              ...
              <div className="flex flex-col justify-center items-center mt-5 md:mt-0 max-w-3xl">
                <h1 className="mb-4 text-center text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
                  <span className="text-transparent bg-clip-text bg-gradient-to-r to-cyan-400 from-cyan-400">
                ...
                <button
                  type="button"
                  className="text-white  hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-200 shadow-lg shadow-cyan-100 dark:shadow-lg dark:shadow-cyan-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                  style={{ background: "#0891b2" }}
                >
              ...
              <div className="md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0 mx-auto">
                <div className="flex flex-col justify-center gap-4 text-center">
                  ...
                  <h1 className="md:leading-[72px] py-2 md:text-6xl text-4xl font-semibold">
                    Join Our Family{" "}
                    <span className="text-[#0891b2]">of Young Learners </span>
                  </h1>
                    ...
                    <table className="min-w-full divide-y divide-gray-200  dark:divide-gray-700 ">
                      <thead>
                        <tr>
                          <th
                            scope="col"
                            className="bg-cyan-400 px-6 py-3 text-center text-xs font-bold text-gray-100 uppercase"
                          >
                            Programme
                          </th>
                          <th
                    ...
                    <table className="min-w-full divide-y divide-gray-200  dark:divide-gray-700">
                      <thead>
                        <tr>
                          <th
                            scope="col"
                            className="bg-cyan-400 px-6 py-3 text-center text-3xl font-medium text-gray-100 uppercase "
                          >
                            Additional Services
                          </th>
