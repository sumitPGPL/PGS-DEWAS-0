  ...
  return (
    <div className="grid gap-4 place-content-center pt-16 items-center flex justify-center h-1/3 place-items-center">
      <ul className="flex justify-between w-full">
        {["Person Info", "Other Info", "Login Info"].map((label, index) => (
          <li
            ...
            className={page === index ? "bg-cyan-200 p-1 w-2/6 rounded-lg" : "bg: transparent"}
          >
              ...
              <span
                className={
                  page === index
                    ...
                    : "ml-2 text-cyan-200 cursor-pointer"
                }
              >
                {label}
              </span>
      ...
      <div className="grid grid-cols-2 gap-4 place-content-center items-center">
        <button
          onClick={handlePrev}
          className="bg-cyan-200 hover:bg-cyan-200 rounded-md text-gray-800 font-bold py-2 px-4 disabled:bg-gray-400 "
          disabled={page === 0}
        >
          Prev
        </button>
        {page === formLength - 1 ? (
          <button
            ...
            className="bg-cyan-200 hover:bg-cyan-200 rounded-md text-gray-800 font-bold py-2 px-4 "
          >
            Submit
          </button>
        ) : (
