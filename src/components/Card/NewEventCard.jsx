...
export default function NewEventCard({ event }) {
  ...
  const searchTerm = "dewas";

  // Check if the lowercase location contains the string 'dewas'
  if (!lowerCaseLocation.includes(searchTerm)) {
    // If location does not contain 'dewas', return null (render nothing)
    return null;
  }
  ...
  return (
    <div className="w-full rounded-xl p-3 bg-cyan-200 border-2 border-tcyan hover:scale-105 transition-transform hover:bg-cyan-200 hover:text-gray-200">
      ...
      <div className="w-full  flex flex-col justify-center p-2">
        ...
        <button
          className="w-1/3 rounded-md p-2 mt-3 bg-gray-200 text-sm outline-none text-black font-semibold duration-100 hover:text-white hover:bg-cyan-800"
          onClick={() => {
