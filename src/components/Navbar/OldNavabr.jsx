                ...
                {menuItem.dropdownItems ? (
                  <Dropdown name={menuItem.name} items={menuItem.dropdownItems}>
                    <div className="flex items-center">
                      <a
                        className="block py-1 px-1 text-xs text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-cyan-700 md:p-0 dark:text-white md:dark:hover:text-cyan-500 dark:hover:bg-gray-700 dark:hover:text-cyan-500 md:dark:hover:bg-transparent dark:border-gray-700"
                        aria-current="page"
                      >
