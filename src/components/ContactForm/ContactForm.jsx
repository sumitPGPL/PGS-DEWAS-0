        ...
        <>
          ...
          <div className="flex justify-center items-center w-screen bg-white">
            ...
            >
              <div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                ...
                <div className="my-2 w-1/2 lg:w-1/4">
                  <button
                    ...
                    className="uppercase text-sm font-bold tracking-wide hover:bg-cyan-700 active:bg-cyan-800 bg-cyan-400 text-gray-100 p-3 rounded-lg w-full 
              ...
              <div className="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-cyan-100 rounded-2xl">
