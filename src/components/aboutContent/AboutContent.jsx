...
const About = () => {
  ...
  const images = [
    ...
    "/gallarySlider/1 (3).jpeg",
    "/gallarySlider/1 (4).jpeg",
    "/gallarySlider/1 (5).jpeg",
    "/gallarySlider/1 (6).jpeg",
  ...
  const [cards, setCards] = useState([
    ...
    },
    {
      ...
      description:
        "Mr. Sachin Tiwari is a passionate educator with over 10 years of experience in guiding young minds. Her warm and nurturing approach creates a welcoming classroom environment where children feel comfortable.",
    },
    {
      name: "Ms. Neeta Khute",
      ...
      description:
        "Ms. Neeta khute is a passionate educator with over 10 years of experience in guiding young minds. Her warm and nurturing approach creates a welcoming classroom environment where children feel comfortable.",
    },
    {
      name: "Ms. Smita Das",
  ...
  const sliderImage = [
    {
      id: 1,
      url: "/gallarySlider/1 (1).jpeg",
    },
    {
      id: 2,
      url: "/gallarySlider/1 (2).jpeg",
    },
    {
      id: 3,
      url: "/gallarySlider/1 (3).jpeg",
    },
    {
      id: 4,
      url: "/gallarySlider/1 (4).jpeg",
    },
    {
      id: 5,
      url: "/gallarySlider/1 (5).jpeg",
    },
    {
      id: 6,
      url: "/gallarySlider/1 (6).jpeg",
    },
  ];
        ...
        <div className="md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0 mx-auto">
          <div className="flex flex-col justify-start gap-4 text-center">
            ...
            <h1 className=" py-2 md:text-6xl text-4xl font-semibold">
              Welcome to <span className="text-[#0891b2]">PGS</span>{" "}
              <span className="text-[#0891b2]">Learners</span> Academy
            </h1>
      ...
      <div className="">
        <div className="pt-6 md:p-8 text-center md:text-middle space-y-4 mb-5">
          ...
          <figcaption className="font-medium">
            {/* Description */}
            <div className="text-cyan-200 dark:text-cyan-400 pb-5">
              Our Children Blossom with Vibrant Hues of Interest in 5+ branches
              across India
            </div>
            {/* Buttons */}
            <div>
              <Button className="bg-cyan-200 p-3 rounded mr-6">
        ...
        {/* Section: Philosophy */}
        <div className="my-10 " style={{ background: "#0891b2" }}>
          {/* Image */}
          <img
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-5 mx-5">
            {cards.map((card, index) => (
              <div
                key={index}
                className="p-[20px] bg-white rounded-xl shadow-cyan-400 border-gray-200 rounded-lg shadow flex-col justify-start items-start gap-[30px] inline-flex"
              >
                ...
                <div className="self-stretch p-[20px] bg-cyan-100 rounded-xl shadow-lg flex-col justify-start items-start gap-5 flex">
